    ...
    return (
        <div className="p-4 max-w-screen-lg m-auto">
            <p>
                ...
                предпринимаемые ИП Керимов Эльвир Адилович (далее — Оператор).
                ...
                о посетителях веб-сайта https://atletikum.ru. 2. Основные
                ...
                сети интернет по сетевому адресу https://atletikum.ru. 2.4.
                ...
                или определяемому Пользователю веб-сайта https://atletikum.ru.
                ...
                веб-сайта https://atletikum.ru. 2.11. Предоставление
                ...
                персональных данных Цель обработки предоставление доступа
                Пользователю к сервисам, информации и/или материалам,
                содержащимся на веб-сайте Персональные данные фамилия, имя,
                отчество номера телефонов год, месяц, дата и место рождения
                ...
                данных Виды обработки персональных данных Сбор, запись,
                систематизация, накопление, хранение, уничтожение и
                обезличивание персональных данных Отправка информационных писем
                на адрес электронной почты 7. Условия обработки персональных
                данных 7.1. Обработка персональных данных осуществляется с
                согласия субъекта персональных данных на обработку его
                персональных данных. 7.2. Обработка персональных данных
                ...
                функций, полномочий и обязанностей. 7.3. Обработка персональных
                данных необходима для осуществления правосудия, исполнения
                ...
                info@atletikum.ru с пометкой «Актуализация персональных данных».
                ...
                электронный адрес Оператора info@atletikum.ru с пометкой «Отзыв
                ...
                info@atletikum.ru. 12.2. В данном документе будут отражены любые
                ...
                сети Интернет по адресу https://atletikum/privacy.
            </p>
        </div>
    );
}
